...
class SettingUi(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Setting", "Form"))
        self.VideoTitile.setText(_translate("Setting", "设置"))
        self.FileTitle.setText(_translate("Setting", "界面设置"))

        self.inputLabel.setText(_translate("Setting", "程序主题"))
